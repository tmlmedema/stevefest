 ...
 *
 * src/lib/helpers/compressImage.ts shrinks photos in the browser on the way in, but
...
/* Kept deliberately in step with src/lib/helpers/compressImage.ts — if the wall's
